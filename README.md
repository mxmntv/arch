...
* **Br_1:** Риск привышения бюджета проекта. При последующих этапах реализации и возможном использовании сторонних (облачных)
вычислительных мощностей, вследствии недооценки количества пользователей (либо обратная ситуация)
* **Br_2:** Смещение сроков реализации функциональности при попытке одновременной реализации всех запланированных функций/фич
приложения
* **Br_3:** Низкая вовлеченность владельцев проекта либо пользователей. Слабо сформулированые бизнес цели и желаемые функции
* **Br_4:** Отсутствие либо сложность найма необходимых сотрудников (аналитики/разработчики/тестировщики)
* **Br_5:** Регуляторный риск (внешний). Изменение законодательства (например по работе с перс. данными)
* **Br_6:** Отсутствие доступности приложения для некоторых групп людей (например людей с ограниченными возможностями)
* **Br_7:** Использование социальных групп приложения не по прямому назначению (маркетинг и пр.)

* **Tr_1:** Неверно подобраны технологии реализации проекта (ЯП, ПО)
* **Tr_2:** Существующая инфраструктура (оборудование, технологии) не подходит для реализации
* **Tr_3:** Большое количество интеграций с внешними системами и зависимость от их работоспособности (либо обновлений)
* **Tr_4:** Неверно расчитано количество предполагаемых пользователелей продукта (не выдержит нагрузки)
* **Tr_5:** Возможность кражи личных и платежных данных пользователей приложения
