...
На первоначальном этапе, при неизвестном количестве пользователей, прихожу к выводу что использование стороннего сервиса не целесообразно, так как:
...
Стоимость расчитана исходя из следующих допущений:
