...
* **Mt_01:** Проектирование и разработка сервиса (сервисов) управления профилем пользователя:
    ...
    * разработка механизмов защиты пользовательских данных:
        ...
        * внедрение аутентификации через сторонние сервисы (Google/Mail.ru/VK/Facebook etc.) [ADR-001: Авторизация через сторонние сервисы ](adrs/ADR-001%20Авторизация%20через%20сторонние%20сервисы.md)
...
* **Mt_03:** Разработка и интеграция служебных сервисов:
    ...
    * разработка сервиса рекомендаций для пользователя:
        * разработка и внедрение алгоритмов машинного обучения для рекомендаций тренировок (в зависимости от параметров пользователя)
...
* **Mt_04:** Релиз и стабилизация:
    ...
    * фиксация дефектов и улучшений, проработка бэклога последующих релизов

### Критически важные компоненты:
* кабинет/пространство пользователя (авторизация, информационная безопасность)
* модуль сбора данных/метрик тренировок пользователя
* сквозная авторизация пользователя
